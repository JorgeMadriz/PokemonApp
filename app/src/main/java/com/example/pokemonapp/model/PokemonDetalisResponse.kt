...
data class PokemonDetalisResponse (
    @Json(name = "abilities")val abilities: List<Abilitie>,
    @Json(name = "base_experience") val baseExperience: Int,
    @Json(name = "forms") val forms: List<Pokemon>,
    ...
    @Json(name = "species")val species: Pokemon,
